...
| Bannières de Cendre | [`kingdom-under-fire/`](kingdom-under-fire/) | RTS médiéval-fantastique 3D original en TypeScript + Three.js : grandes armées instanciées, 6 formations, combat de mêlée, moral, IA à vision limitée (premier prototype) |
...
npm install
npm run assets   # facultatif : télécharge les assets tiers (pas de script d'assets dans kingdom-under-fire)
npm run dev
```
